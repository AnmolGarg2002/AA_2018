...
public:
   ...
   void write_jpeg(const char *savename, J_COLOR_SPACE colorspace = RGB, int quality=98) //writes image with name savename with passed quality (1-100)
   {
   ...
   void display(const char *savename, int save_flag=DO_NOT_SAVE, J_COLOR_SPACE colorspace=RGB) //function to display image after saving at path savename
   {
